...
\include{chapters/00-Allgemeine-Formeln}
\include{chapters/01-Vektoren-Matrizen-Gleichungssysteme}
\include{chapters/02-Gauss-Algorithmus}
\include{chapters/03-LU-Zerlegung}
\include{chapters/04-Gauss-Jordan-Elimination}
\include{chapters/05-Vektorprodukt-Lineare-Abbildungen}
\include{chapters/06-Orthogonale-Abbildungen-Homogene-Koordinaten}
\include{chapters/07-Einfache-lineare-Regression}
\include{chapters/08-Multiple-lineare-Regression}
\include{chapters/09-Eigenwerte-und-Eigenvektoren-I}
\include{chapters/10-Eigenwerte-und-Eigenvektoren-II}
\include{chapters/11-Singulärwertzerlegung-I}
\include{chapters/12-Singulärwertzerlegung-II}
